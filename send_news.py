...
text_news = str(open("/sdcard/work/news/public/news.txt","r").read())



cn(file_news="/sdcard/work/news/public/news.mp4",
   title="Urgente!!",
   text=text_news,
   font="/sdcard/work/news/quiva.ttf",  
   path_bg="/sdcard/work/news/news_bg.jpg",
   path_img="/sdcard/work/news/public/news.jpg",
   path_song="/sdcard/work/news/news_song.m4a",
